$(document).ready(function () {
    ...
    tl.from(".homeslider-description h2", 0.3, { top: -100, autoAlpha: 0 }).from(".homeslider-description p", 0.3, { left: -600, autoAlpha: 0 }).from(".homeslider-description button", 0.1, { bottom: -100, autoAlpha: 0 }); function pagSel() {
    ...
    $("#homepage-slider").on("mouseover", function () { $("#bx-pager-thumb", this).addClass("active"); })
